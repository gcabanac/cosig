...
\cosigsection{Citations to retracted publications}
...
\begin{comment}
Reese: I would argue that both of these cases are closer to Example 1 than being examples where an article is not impacted by retracted citations. The second example (the Frontiers review article) is mostly citations to papers that were retracted previously! I would argue that these citations are especially problematic and do in fact significantly impact the information presented in the citing article.

Perhaps there is another example that has just one non-consequential citation to a retracted article in the background section?
...
\begin{itemize}
    ...
    \item \href{https://www.irit.fr/~Guillaume.Cabanac/problematic-paper-screener/feet-of-clay}{The Problematic Paper Screener: Feet of Clay Detector}
    \item \href{https://doi.org/10.1162/qss_a_00155}{``Continued use of retracted papers: Temporal trends in citations and (lack of) awareness of retractions shown in citation contexts in biomedicine'' (2022)}
    \item \href{https://doi.org/10.1378/chest.11-0523}{``Exclusive: the papers that most heavily cite retracted studies'' (2024)}
    \item \href{https://doi.org/10.1001/jamainternmed.2025.0256}{``Inclusion of Retracted Studies in Systematic Reviews and Meta-Analyses of Interventions: A Systematic Review and Meta-Analysis'' (2025)}
\end{itemize}
